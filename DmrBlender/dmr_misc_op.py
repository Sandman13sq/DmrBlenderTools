...
class DMR_OP_EDITMODEWEIGHTS(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
classlist.append(DMR_OP_EDITMODEWEIGHTS);

# =============================================================================

class DMR_OP_TOGGLEPOSE(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
classlist.append(DMR_OP_TOGGLEPOSE);
...
class DMR_OP_PLAYANIM(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
classlist.append(DMR_OP_PLAYANIM);

# =============================================================================

class DMR_OP_IMGRELOAD(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        return {'FINISHED'}
classlist.append(DMR_OP_IMGRELOAD);
